...
async function inicializar() {
  ...
  // Traer datos actualizados desde Supabase (si hay conexión)
  // Esto actualiza el localStorage con los datos más recientes del servidor
  if (typeof supaCargarTodo === 'function') {
    await supaCargarTodo();
  }

  // Inicializar la app con los datos (locales o de Supabase)
